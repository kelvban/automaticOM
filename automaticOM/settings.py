"""
Django settings for automaticOM project.
...
SECRET_KEY = 'xe##xp7fl+cfg))hs1gh&m)dzlq-p7fd)&q5yxd-+p8b1%@wij'
...
WSGI_APPLICATION = 'automaticOM.wsgi.application'
